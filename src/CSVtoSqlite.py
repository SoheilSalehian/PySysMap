...
try:
    ...
    cursor.execute('''CREATE TABLE IF NOT EXISTS ScholarTable
                      (title VARCHAR[700], url VARCHAR[300], num_citations INT, num_versions INT, 
                      url_citations VARCHAR[300], url_versions VARCHAR[300], abstract TEXT, year INT)''')
    

    # Read the CSV file with the seperator "|"
    csv_data = csv.reader(open('/home/soheil/workspace/PySysMap/src/embeddedAgile.csv', "rb"), delimiter='|')
